 ...
 * @author Daniel
 */
public class FrmRegSupervisor extends javax.swing.JInternalFrame {
...
private EmpleadoController empC = new EmpleadoController();
    ...
    public FrmRegSupervisor() {
        initComponents();
        cargarCmbDepartamento();
    }

    public void cargarCmbDepartamento() {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Registro Supervisor");
        setAlignmentX(10.0F);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de Supervisor de CV", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if(this.validator.emptyFields(jPanel2)) {
            ...
            SupervisorCentroV sup = new SupervisorCentroV();
            ...
            sup.setIdCentro( idMuni );
            
            String msj = this.empC.insertarSupervisorCentro(sup);
